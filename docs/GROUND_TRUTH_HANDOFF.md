...
## Panel status — 14 volumes / 893 lines (continuous 1786–1925; col 1→6 complete; all 8 fields)
...
**Deep: 5 of 14** (lain1876, trow1907, trow1913, polk1917, polk1925). **First real numbers** = GLiNER
...
**Next priority = breadth, not depth** — the layout (col 1–6) and all 8 fields are covered. In
progress: **Polk 1933/34 Staten Island** (col 2, first **outer borough** + 1930s). Then the other

...
> browser-only). **11 volumes labeled = 688 lines** (era coverage 1786–1907, all 8 fields exercised,
> layout col 1→3): lain1876 (103), boyd1890 (75), doggett1846 (37), duncan1794 (58), franks1786 (56),
...
> surname-dash dittos), all validator-clean (Trow 1913 col-4 in progress). GLiNER floor scored on
> lain1876 (macro-F1 0.33, `address` weakest). Conventions

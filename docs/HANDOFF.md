...
> browser-only). **12 volumes labeled = 781 lines** (era coverage 1786–1913, all 8 fields exercised,
> layout col 1→4): lain1876 (103), boyd1890 (75), doggett1846 (37), duncan1794 (58), franks1786 (56),
...
> surname-dash dittos), trow1913 (93 — col-4), all validator-clean (Polk 1917 col-5 in progress).
> GLiNER floor scored on lain1876 (macro-F1 0.33, `address` weakest). Conventions
